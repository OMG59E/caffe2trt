...
#include "trt/parsers/caffe/caffeWeightFactory/weightType.h"
#include "trt/parsers/caffe/proto/trtcaffe.pb.h"

namespace nvcaffeparser1 {
    class CaffeWeightFactory {
    public:
        CaffeWeightFactory(const trtcaffe::NetParameter& msg, nvinfer1::DataType dataType,
        ...
        nvinfer1::Weights allocateWeights(int64_t elems,
